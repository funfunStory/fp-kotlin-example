...
fun <T> FunStream<FunStream<T>>.flatten(): FunStream<T> = TODO()

fun <T, R> FunStream<T>.foldRight(acc: R, f: (T, R) -> R): R = TODO()

infix fun <T, R> FunStream<T>.flatMap(f: (T) -> FunStream<R>): FunStream<R> = TODO()